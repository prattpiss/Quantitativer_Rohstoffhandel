...
**Alle neuen Dateien, Scripts und Outputs gehören ausschließlich in:**
```
C:\Users\Labor\Desktop\Neuer Ordner\Commodities\Commodities_Strategy_CrudeOil_JetsETF_Pairtrading\
```
Das übergeordnete Repo (`C:\Users\Labor\Desktop\Neuer Ordner\Commodities\`) bleibt unberührt — nur lesen (z.B. `outputs/tables/`, `reports/report_builder.py` als Referenz). Neue Reports, Scripts und Daten kommen ausschließlich in den Unterordner.

---

*Erstellt: September 2026 | Projekt: Commodity & Airline Research Framework*
*Arbeitsverzeichnis: `C:\Users\Labor\Desktop\Neuer Ordner\Commodities\Commodities_Strategy_CrudeOil_JetsETF_Pairtrading`*
